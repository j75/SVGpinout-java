...
enum Edge {
    ...
    BOTTOM {
        ...
        InsertCoordinates computePosition (int corner_offset, float pin_offset, int chip_h, int maxPinSize,
            ...
            double[] pin_insert = ArrayUtils.toDoubleArray(corner_offset + pin_offset,
                    chip_h + maxPinSize + AbstractDrawChipSVG.arrow_length);
            ...
            int[] pin_size = ArrayUtils.toIntArray(AbstractDrawChipSVG.pin_width, maxPinSize); //(str(pin_width) + "px", str(pin_length) + "px")
            short text_rotation = -90; // "rotate(-90)"
            // orig: (pin_insert[1] + maxPinSize, -pin_insert[0] - DrawChip.pin_width);
            int[] arrow_insert = ArrayUtils.toIntArray (pin_insert[1] + maxPinSize, -pin_insert[0] - AbstractDrawChipSVG.pin_width);
    ...
    RIGHT {
        ...
        InsertCoordinates computePosition (int corner_offset, float pin_offset, int chip_h, int maxPinSize,
                                          double number_length, int chip_w,
                                          int bottom_offset, double centering, int right_offset) {
            double[] pin_insert = ArrayUtils.toDoubleArray(chip_w + maxPinSize + AbstractDrawChipSVG.arrow_length, bottom_offset - pin_offset);
            ...
            int[] pin_size = ArrayUtils.toIntArray(maxPinSize, AbstractDrawChipSVG.pin_width); // (str(pin_length) + "px", str(pin_width) + "px")
    ...
    UP {
        ...
        InsertCoordinates computePosition(int corner_offset, float pin_offset, int chip_h, int maxPinSize,
            ...
            double[] pin_insert = ArrayUtils.toDoubleArray(right_offset - pin_offset, AbstractDrawChipSVG.arrow_length);
            ...
            int[] pin_size = ArrayUtils.toIntArray(AbstractDrawChipSVG.pin_width, maxPinSize); //(str(pin_width) + "px", str(pin_length) + "px")
            short text_rotation = -90; // "rotate(-90)"
            int[] arrow_insert = ArrayUtils.toIntArray(-AbstractDrawChipSVG.arrow_length, pin_insert[0]);
    ...
    LEFT {
        ...
        InsertCoordinates computePosition(int corner_offset, float pin_offset, int chip_h, int maxPinSize,
                                         double number_length, int chip_w,
                                         int bottom_offset, double centering, int right_offset) {
            double[] pin_insert = ArrayUtils.toDoubleArray(AbstractDrawChipSVG.arrow_length, corner_offset + pin_offset);
            float[] text_insert = ArrayUtils.toFloatArray(pin_insert[0] + centering, pin_insert[1] + YTEXT_OFFSET);
            ...
            int[] arrow_insert = ArrayUtils.toIntArray(-AbstractDrawChipSVG.arrow_length, -pin_insert[1] - AbstractDrawChipSVG.pin_width);
